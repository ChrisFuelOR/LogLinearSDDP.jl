...
function prepare_ar_model()
    ...
    for system_number in 1:4
        ...
        #######################################################################################
        # model_cross_output(all_monthly_models, std_errors, "../PreparationAutoregressive/cross_log_model/model_" * system_name * ".txt")
    ...
    # file_name = "../PreparationAutoregressive/cross_log_model/" * "scenarios_nonlinear.txt"
    # f = open(file_name, "w")
