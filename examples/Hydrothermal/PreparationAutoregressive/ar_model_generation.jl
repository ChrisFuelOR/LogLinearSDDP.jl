...
function prepare_ar_model()
    ...
    for system_number in 1:4
        ...
        #######################################################################################
        push!(psi, model_cross_output(all_monthly_models, "../PreparationAutoregressiveLinearized/cross_lin_model/model_lin_" * system_name * ".txt"))
    ...
    file_name = "../PreparationAutoregressiveLinearized/cross_lin_model/" * "scenarios_linear.txt"
    f = open(file_name, "w")
