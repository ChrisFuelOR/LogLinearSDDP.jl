...
import Random
include("PreparationAutoregressive.jl")
include("../read_and_write_files.jl")
import .PreparationAutoregressive
...
function history_generation(model_directory::String)
    ...
    historic_data_SE = PreparationAutoregressive.data_frame_to_vector(last(PreparationAutoregressive.read_raw_data("historical_data/hist1.csv"), 1))
    historic_data_S = PreparationAutoregressive.data_frame_to_vector(last(PreparationAutoregressive.read_raw_data("historical_data/hist2.csv"), 1))
    historic_data_NE = PreparationAutoregressive.data_frame_to_vector(last(PreparationAutoregressive.read_raw_data("historical_data/hist3.csv"), 1))
    historic_data_N = PreparationAutoregressive.data_frame_to_vector(last(PreparationAutoregressive.read_raw_data("historical_data/hist4.csv"), 1))
